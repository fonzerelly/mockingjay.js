            ...
            request
                ...
                .end((err, realRes) => {
                    if (err) {
                        ...
                        /* Since lowdb for inMemoryOnly-Mode does not provide a write-method
                         * we can not assue it is there always. This seems to be a lowdb
                         * fraud, we have to work around here
                         */
                        if (db.write) {
                            db.write()
                        }
