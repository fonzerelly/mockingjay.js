...
describe('server', () => {
    ...
    describe('callback', () => {
        ...
        it('should call the callback when server is started', (done) => {
            const cb = jasmine.createSpy().and.callFake(done)
            instance = server.init(db, port, cb)

            // In this tick, callback must not yet be called. It should be called
            // later, which is proven by calling done properly
